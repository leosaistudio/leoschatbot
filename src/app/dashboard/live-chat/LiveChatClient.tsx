...
import { MessageSquare, User, Bot, Send, ArrowRight, Phone, RefreshCw, Zap } from 'lucide-react'
                        ...
                        {conversations.map((conv) => (
                            ...
                            >
                                <div className="flex items-start gap-3">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center ${conv.status === 'human_takeover'
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className={`text-xs px-2 py-0.5 rounded-full ${conv.status === 'human_takeover'
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    {selectedConversation?.pageUrl && (
                                        <p className="text-xs text-slate-500 truncate max-w-xs">{selectedConversation.pageUrl}</p>
                                    )}
                                </div>
                            </div>
                                ...
                                <div className="space-y-4 max-w-2xl mx-auto">
                                    {messages.map((msg) => (
                                        ...
                                        >
                                            ...
                                            <div className={`max-w-md py-3 px-4 rounded-2xl ${msg.role === 'user'
                            ...
                            <form onSubmit={sendMessage} className="bg-white border-t border-slate-200 p-4">
                                <div className="flex gap-3 max-w-2xl mx-auto">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition disabled:opacity-50 flex items-center gap-2"
                                    >
                                        <Send size={18} />
                                        שלח
                                    </button>
